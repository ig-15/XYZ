 ...
 */
router.post('/', authorizeRoles(['admin']), parkingsController.createParking);
 ...
 *         description: Parking lot not found
 */
router.put('/:id', authorizeRoles(['admin']), parkingsController.updateParking);
 ...
 *         description: Parking lot not found
 */
router.delete('/:id', authorizeRoles(['admin']), parkingsController.deleteParking);
 ...
 *         description: Parking lot not found
 */
router.put('/:id/spaces', authorizeRoles(['admin', 'attendant']), parkingsController.updateAvailableSpaces);
