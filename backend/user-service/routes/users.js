 ...
 */
router.get('/:id', authorizeRoles(['admin', 'attendant']), usersController.getUserById);
 ...
 *         description: User not found
 */
router.get('/:id/logs', authorizeRoles(['admin']), usersController.getUserLogs);
 ...
 *         description: User not found
 */
router.put('/:id/role', authorizeRoles(['admin']), usersController.updateUserRole);
