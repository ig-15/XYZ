 ...
 */
router.get('/entry-exit-logs', authorize(['admin', 'attendant']), reportsController.getEntryExitLogs);
 ...
 *         description: Unauthorized
 */
router.get('/revenue/by-parking', authorize(['admin']), reportsController.getRevenueByParking);
 ...
 *         description: Unauthorized
 */
router.get('/revenue/daily', authorize(['admin']), reportsController.getDailyRevenue);
 ...
 *         description: Unauthorized
 */
router.get('/parking-usage', authorize(['admin']), reportsController.getParkingUsage);
 ...
 *         description: Unauthorized
 */
router.get('/user-activity', authorize(['admin']), reportsController.getUserActivityLogs);
