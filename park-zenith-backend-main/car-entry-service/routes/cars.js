 ...
 */
router.get('/', authorize(['admin', 'attendant']), carsController.getAllCars);
 ...
 */
router.get('/search', authorize(['admin', 'attendant']), carsController.searchCarByPlate);
 ...
 */
router.get('/:id', authorize(['admin', 'attendant']), carsController.getCarById);
 ...
 */
router.post('/', authorize(['admin', 'attendant']), carsController.registerCar);
 ...
 */
router.put('/:id', authorize(['admin', 'attendant']), carsController.updateCar);
 ...
 *         description: Car not found
 */
router.delete('/:id', authorize(['admin']), carsController.deleteCar);
 ...
 *         description: Car not found
 */
router.get('/:id/history', authorize(['admin', 'attendant']), carsController.getCarHistory);
