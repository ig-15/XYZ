 ...
 */
router.get('/', authorize(['admin', 'attendant']), ticketsController.getAllTickets);
 ...
 */
router.get('/:id', authorize(['admin', 'attendant']), ticketsController.getTicketById);
 ...
 */
router.get('/user/:userId', authorize(['admin', 'attendant', 'user']), ticketsController.getUserTickets);
