 ...
 */
router.get('/', authorize(['admin', 'attendant']), entriesController.getAllEntries);
 ...
 *         description: Unauthorized
 */
router.get('/active', authorize(['admin', 'attendant']), entriesController.getActiveEntries);
 ...
 */
router.get('/:id', authorize(['admin', 'attendant']), entriesController.getEntryById);
 ...
 */
router.post('/', authorize(['admin', 'attendant']), entriesController.registerEntry);
 ...
 *         description: Entry not found
 */
router.post('/:id/exit', authorize(['admin', 'attendant']), entriesController.registerExit);
